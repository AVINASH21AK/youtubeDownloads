package com.yudownloader.service;
...
import com.yudownloader.get.DownloadManagerImpl;
import com.yudownloader.get.DownloadMission;
import com.yudownloader.ui.main.MainActivity;
import com.yudownloader.util.Settings;

import static com.yudownloader.BuildConfig.DEBUG;
...
public class DownloadManagerService extends Service implements DownloadMission.MissionListener
{
	...
	public void onCreate() {
		...
		mNotification = new Notification.Builder(this)
			...
			.setLargeIcon(((BitmapDrawable) getResources().getDrawable(R.drawable.ic_noti_download)).getBitmap())
